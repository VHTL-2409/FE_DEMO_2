    ...
    <header class="mb-2 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
      <div class="min-w-0 space-y-2">
        ...
        >
          ...
          <span class="text-slate-400">{{ sectionEyebrow }}</span>
        </nav>
        <h1 class="admin-stitch-page-title">{{ sectionTitle }}</h1>
        <p class="teacher-page-lead max-w-3xl">{{ sectionSubtitle }}</p>
      </div>
    </header>

    <div
      v-if="showSearch"
      class="staff-surface staff-surface-strong rounded-[1.5rem] p-4 sm:p-5 flex shrink-0 flex-col gap-3 sm:flex-row sm:items-center"
    >
      <div class="relative flex-1 max-w-xl">
        ...
        <input
          ...
          class="staff-search-input w-full rounded-xl pl-10 pr-4 py-2.5 text-sm placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-amber-500/25"
        ...
        >
          ...
          <div v-else-if="detail" class="space-y-4 px-5 py-5 text-sm">
            ...
            <dl class="grid grid-cols-1 gap-3">
              ...
              <div class="flex justify-between gap-4 border-b border-slate-700/50 pb-2">
                <dt>Username</dt>
                <dd class="font-mono text-primary-300">{{ detail.username }}</dd>
              </div>
              <div class="flex justify-between gap-4 border-b border-slate-700/50 pb-2">
                <dt>Email</dt>
