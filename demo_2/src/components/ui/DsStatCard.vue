<template>
  <div
    :class="[
      ...
      'rounded-[var(--ds-radius-xl)] border border-[var(--ds-border)] p-5 transition-all duration-200',
      'hover:-translate-y-0.5 hover:shadow-[var(--ds-shadow-lg)] hover:border-[var(--ds-primary-border)]',
...
const props = defineProps({
  ...
  accentColor: { type: String, default: '#b15f00' },
...
const accentGlowColor = computed(() => {
  ...
  return map[props.accentColor] || '#b15f00'
})
