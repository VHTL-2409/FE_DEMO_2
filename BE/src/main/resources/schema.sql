...
ALTER TABLE IF EXISTS exams ADD COLUMN IF NOT EXISTS max_attempts INTEGER DEFAULT 1 NOT NULL;
ALTER TABLE IF EXISTS exams ADD COLUMN IF NOT EXISTS allow_review_after_submit BOOLEAN DEFAULT TRUE NOT NULL;
