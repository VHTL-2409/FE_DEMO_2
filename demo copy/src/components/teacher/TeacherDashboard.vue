...
const goToExamList = () => router.push('/teacher/exams/list')

const handleQuickAction = (actionId) => {
  const actions = {
    create: () => goToCreate(),
    list: () => goToExamList(),
    monitoring: () => goToMonitoring(),
    analytics: () => goTab('analytics'),
    profile: () => router.push('/teacher/profile'),
    help: () => router.push('/help-center')
  }
  actions[actionId]?.()
}
