    ...
    <div class="ps__content">
      ...
      <div class="ps__section">
        ...
        <div class="ps__options">
          ...
          <div class="ps__option-row">
            <div class="ps__option-info">
              <span class="ps__option-label">Múi giờ</span>
              <span class="ps__option-desc">Múi giờ để hiển thị thời gian</span>
            </div>
            <select
              :value="preferences.timezone"
              class="ps__select"
              @change="setPref('timezone', $event.target.value)"
            >
              <option value="Asia/Ho_Chi_Minh">ICT (UTC+7) — Hồ Chí Minh</option>
              <option value="Asia/Bangkok">ICT (UTC+7) — Bangkok</option>
