<template>
  ...
  >
    <div class="layout-container flex h-full grow flex-col">
      ...
      <main class="flex-1 max-w-[1280px] mx-auto w-full p-4 lg:p-8">
        <div class="mb-6">
          ...
          <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
            ...
            <button class="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-primary text-white font-bold rounded-lg hover:bg-primary/90 transition-all shadow-sm" type="button">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <div class="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm" v-for="card in summaryCards" :key="card.title">
