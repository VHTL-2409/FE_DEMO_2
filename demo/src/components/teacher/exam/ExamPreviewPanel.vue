...
const checklist = computed(() => [
  ...
  },
  {
    ...
    warn: false,
    sub: props.form.questions && props.form.questions.length > 0
      ? 'Rà soát nội dung và đáp án trước khi xuất bản'
      : 'Bước này mở sau khi đã nhập được câu hỏi'
  },
  {
    key: 'publish',
