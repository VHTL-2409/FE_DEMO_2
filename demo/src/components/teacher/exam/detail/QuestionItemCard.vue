<template>
  ...
  >
    ...
    <div class="qic__main" @click="expanded = !expanded">
      ...
      <!-- Content -->
      <div class="qic__body">
        <div class="qic__content">
          <MathDisplay
            :content="question.content"
            :latex-content="question.latexContent ?? null"
    ...
    <div v-if="expanded" class="qic__detail">
      <div v-if="parsedOptions.length > 0" class="qic__options">
        ...
        >
          ...
          <div class="qic__opt-text">
            <MathDisplay
              :content="opt.text || opt.label || opt.content"
      ...
      <div v-else-if="hasRawOptions" class="qic__options">
        <div v-if="question.optionA" class="qic__opt" :class="{ 'qic__opt--correct': question.correctAnswer === 'A' }">
          ...
          <div class="qic__opt-text">
            <MathDisplay :content="question.optionA" :latex-content="latexOptionFor('A')" source-preference="latex-first" />
          </div>
        ...
        <div v-if="question.optionB" class="qic__opt" :class="{ 'qic__opt--correct': question.correctAnswer === 'B' }">
          ...
          <div class="qic__opt-text">
            <MathDisplay :content="question.optionB" :latex-content="latexOptionFor('B')" source-preference="latex-first" />
          </div>
        ...
        <div v-if="question.optionC" class="qic__opt" :class="{ 'qic__opt--correct': question.correctAnswer === 'C' }">
          ...
          <div class="qic__opt-text">
            <MathDisplay :content="question.optionC" :latex-content="latexOptionFor('C')" source-preference="latex-first" />
          </div>
        ...
        <div v-if="question.optionD" class="qic__opt" :class="{ 'qic__opt--correct': question.correctAnswer === 'D' }">
          ...
          <div class="qic__opt-text">
            <MathDisplay :content="question.optionD" :latex-content="latexOptionFor('D')" source-preference="latex-first" />
          </div>
...
const latexOptionFor = (optionId) => {
  const lo = props.question.latexOptions
  if (!lo) return null
  if (typeof lo === 'string') {
    try {
  ...
  return lo?.[optionId] ?? lo?.[String(optionId).toUpperCase()] ?? null
}
...
const isCorrectOption = (optId) => {
  ...
  if (Array.isArray(correct)) {
    return correct.map((value) => String(value).toUpperCase()).includes(normalizedOpt)
  }
  const normalizedCorrect = String(correct).toUpperCase()
  if (normalizedCorrect.includes(',')) {
    return normalizedCorrect.split(',').map((value) => value.trim()).includes(normalizedOpt)
  }
