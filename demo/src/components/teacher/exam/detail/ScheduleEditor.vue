  ...
  <div class="se">
    <div class="se__section">
      ...
      <div class="se__body">
        ...
        <!-- Timezone -->
        <div class="se__field">
          <label class="se__label">Múi giờ <span class="se__optional">(tự động)</span></label>
          <select v-model="localTimezone" class="se__select">
...
const emit = defineEmits([
  'update:startTime', 'update:endTime', 'update:timezone', 'update:durationMinutes'
])
...
.se__input:focus { border-color: var(--ds-primary); box-shadow: 0 0 0 3px var(--ds-primary-ring); }
...
.se__select:focus { border-color: var(--ds-primary); box-shadow: 0 0 0 3px var(--ds-primary-ring); }
